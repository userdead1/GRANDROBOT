...
TECHNO_IMG = "https://telegra.ph/𝐀ᴛᴛɪᴛᴜᴅᴇ-12-03"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/USEARDEAD")],
                                                                                   [InlineKeyboardButton(text="ADD JACK_ROSE_B_BOT TO YOUR GROUP",
        ...
        update.effective_message.reply_text("HA BHAI BOL KAISE YAAD KIA 🙃😂⚡")
